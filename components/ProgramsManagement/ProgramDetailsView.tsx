    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-4 gap-3">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
          <p className="text-xs text-#4885ed font-semibold">Total Classes</p>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-3">
          <p className="text-xs text-#db3236 font-semibold">Enrolled</p>
          <p className="text-2xl font-bold text-[#881f1f] mt-1">{stats.totalEnrolled}</p>
        </div>
      ...
      <input
        ...
        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-#db3236"
      />
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {classStudents.map((student) => (
                        <span
                          key={student.id}
                          className="text-xs bg-red-100 text-[#9b2c2c] px-2 py-1 rounded"
                        >
